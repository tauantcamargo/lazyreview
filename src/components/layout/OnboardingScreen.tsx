...
const ONBOARDING_STEPS: readonly OnboardingStep[] = [
  {
    ...
    lines: [
      'LazyReview is a terminal-based code review tool for GitHub PRs.',
      '',
      'Review pull requests, browse diffs, leave comments, approve or',
  ...
  },
  {
    ...
    lines: [
      'LazyReview needs a GitHub token with repo and read:user scopes.',
      '',
      'Token sources (in priority order):',
      '  1. LAZYREVIEW_GITHUB_TOKEN env variable',
      '  2. Manually entered token (saved to ~/.config/lazyreview/.token)',
      '  3. GITHUB_TOKEN env variable',
      '  4. gh CLI (gh auth token)',
      '',
      "You'll be prompted for a token next if none is found.",
    ],
  },
]
