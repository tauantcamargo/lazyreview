...
const SCREEN_CONTEXT_HINTS: Record<ScreenContext, string> = {
  ...
  'pr-detail-files': 'j/k:nav  h/l:tree/diff  /:filter  v:select  c:comment  r:reply  x:resolve  R:review  S:batch  g:checkout',
  'pr-detail-conversations': 'j/k:nav  c:comment  r:reply  e:edit  x:resolve  f:resolved  R:review  S:batch  E:re-review  g:checkout',
  'pr-detail-commits': 'j/k:nav  y:copy-sha  R:review  S:batch  E:re-review  m:merge  g:checkout',
